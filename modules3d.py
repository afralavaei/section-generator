...
# ── Native 3D modules (from Rhino exports) ────────────────────────────────────
# Axes: x=width, y=height, z=depth (Rhino y↔z swapped at export time).
# Ports sit on module faces: left x=0, right x=w, bottom y=0, top y=h,
# front z=0, back z=d.

_NATIVE_3D: Dict[str, dict] = {
    # Connector pieces bridging chair tops (z=1,2) to roof bottom (z=1,2)
    "conn_chair_roof_left": {
        "id":          "conn_chair_roof_left",
        "w": 2, "h": 1, "d": 3,
        "zone":        "filler",
        "description": "Connects chair_left top ports to roof bottom ports (left side).",
    ...
    "conn_chair_roof_right": {
        ...
        "w": 2, "h": 1, "d": 3,
        "zone":        "filler",
        "description": "Connects chair_right top ports to roof bottom ports (right side).",
        "tags":        ["native3d", "connector"],
        "segments": [
    ...
    "roof_3d_v1": {
        ...
        "w": 6, "h": 3, "d": 3,
        "zone":        "roof",
        "description": "Full-width roof, native 3D from Rhino. Plan-view tent shape, 4 bottom ports.",
        "tags":        ["native3d", "roof"],
        "segments": [
    ...
    "chair_right_3d_v1": {
        ...
        "w": 2, "h": 2, "d": 3,
        "zone":        "chair_right",
        "description": "Right-facing chair, native 3D from Rhino. Mirror of chair_left. Seat at mid-depth.",
    ...
    "chair_left_3d_v1": {
        ...
        "w": 2, "h": 2, "d": 3,
        "zone":        "chair_left",
        "description": "Left-facing chair, native 3D from Rhino. Seat floats at mid-depth (z=1–2).",
