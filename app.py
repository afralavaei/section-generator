...
with st.sidebar:
    ...
    if section_type == "Dining":
        ...
        dining_choice = st.radio(
            ...
            horizontal=True,
            help="Compact = flush chairs, narrower section.  Spacious = wide-top tables with gap columns.",
        )
    ...
    if mode == "3D":
        ...
        D = int(st.number_input(
            "Depth D", min_value=3, max_value=9, value=3, step=1,
            help="Depth in cells (3–9).",
        ))
    else:
        H = int(st.number_input(
            "Height H", min_value=7, max_value=20, value=7, step=1,
